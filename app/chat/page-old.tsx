...
import { MessageCircle, Send, Mic, MicOff, Volume2, VolumeX, AlertTriangle, Phone, Bot, User } from "lucide-react"
...
const supportiveResponses = {
  en: {
    crisis: "I'm really concerned about what you're sharing. Your life has value and there are people who want to help. Please reach out to a crisis helpline immediately: NIMHANS: 080-26995000 or Vandrevala Foundation: 9999666555. Would you like me to connect you with emergency support?",
    general: "I understand you're going through a difficult time. I'm here to listen and provide support. How are you feeling right now?",
    greeting: "Hello! I'm your AI mental health companion. I'm here to provide support, resources, and a safe space to talk. How can I help you today?",
  },
  hi: {
    crisis: "मुझे चिंता है कि आप क्या साझा कर रहे हैं। आपके जीवन की कीमत है और ऐसे लोग हैं जो आपकी मदद करना चाहते हैं। कृपया तुरंत क्राइसिस हेल्पलाइन से संपर्क करें: NIMHANS: 080-26995000 या वंदे रेवाला फाउंडेशन: 9999666555।",
    general: "मैं समझता हूं कि आप एक कठिन समय से गुजर रहे हैं। मैं यहां सुनने और सहायता प्रदान करने के लिए हूं। आप अभी कैसा महसूस कर रहे हैं?",
    greeting: "नमस्ते! मैं आपका AI मानसिक स्वास्थ्य साथी हूं। मैं सहायता, संसाधन और बात करने के लिए एक सुरक्षित स्थान प्रदान करने के लिए यहां हूं।",
  }
}
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-6 max-w-4xl">
        ...
        <Alert className="mb-6 border-destructive/50 bg-destructive/10">
          ...
          <AlertDescription>
            <strong>Crisis Support:</strong> If you're in immediate danger, please call emergency services or contact:
            NIMHANS (080-26995000), Vandrevala Foundation (9999666555), or iCall (9152987821)
          </AlertDescription>
        </Alert>
        ...
        <Card className="h-[600px] flex flex-col">
          <CardHeader className="pb-4">
            ...
            <p className="text-sm text-muted-foreground">
              This is a safe space to share your thoughts and feelings. I'm here to listen and provide support.
            </p>
          </CardHeader>
          ...
          <CardContent className="flex-1 flex flex-col p-0">
            ...
            <div className="border-t p-4">
              ...
              <p className="text-xs text-muted-foreground mt-2">
                Press Enter to send. This conversation is confidential and not stored permanently.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="mt-6 grid md:grid-cols-3 gap-4">
          <Card className="p-4">
            ...
            <p className="text-sm text-muted-foreground mb-3">Connect with a licensed counselor</p>
          ...
          <Card className="p-4">
            ...
            <p className="text-sm text-muted-foreground mb-3">Self-help guides and wellness tools</p>
            <Button variant="outline" size="sm" asChild>
          ...
          <Card className="p-4">
            ...
            <p className="text-sm text-muted-foreground mb-3">Connect with peer support groups</p>
            <Button variant="outline" size="sm" asChild>
