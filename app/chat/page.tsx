...
import { Heart, Send, Bot, User, AlertTriangle, MessageCircle } from "lucide-react"
...
const supportiveResponses = [
  ...
  },
  {
    ...
    response:
      "I hear that you're going through a difficult time. These feelings are valid, and you're not alone. Many students experience similar challenges. Have you been able to maintain your daily routines like eating and sleeping? Small steps can make a big difference.",
  },
  {
    keywords: ["stressed", "overwhelmed", "pressure", "exam"],
    response:
      "Academic stress is very common, especially during exam periods. Let's break this down - what specific aspect is causing you the most stress? Sometimes organizing tasks into smaller, manageable pieces can help reduce that overwhelming feeling.",
  },
  {
    keywords: ["lonely", "isolated", "alone", "friends"],
    response:
      "Feeling lonely, especially in college, is more common than you might think. Many students struggle with social connections. Have you considered joining any clubs or study groups? Sometimes starting with academic connections can lead to meaningful friendships.",
  },
]
