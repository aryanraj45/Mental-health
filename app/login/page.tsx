...
const mockStudents: Student[] = [
  ...
  { id: "4", name: "Ananya Singh", email: "ananya.singh@college.edu", rollNo: "BT2021007", course: "Biotechnology", year: 3, avatar: "/placeholder-user.jpg", lastActive: new Date(Date.now() - 15 * 6e4), mentalHealthScore: 25, riskLevel: "critical", sessionsCompleted: 3, moodTrend: "declining", emergencyAlerts: 3, lastAssessment: new Date(Date.now() - 1 * 36e5), radarData: [{ subject: 'Academic', value: 30 }, { subject: 'Social', value: 25 }, { subject: 'Emotional', value: 15 }, { subject: 'Coping', value: 20 }, { subject: 'Sleep', value: 40 }], scoreHistory: [{ month: 'Jan', score: 40 }, { month: 'Feb', score: 35 }, { month: 'Mar', score: 30 }, { month: 'Apr', score: 25 }], activityLog: [{ time: new Date(Date.now() - 15 * 6e4), activity: "Flagged community post", icon: Flag }, { time: new Date(Date.now() - 25 * 36e5), activity: "Emergency alert triggered", icon: AlertTriangle }], adminNotes: "CRITICAL: Multiple alerts triggered. Assigned to Dr. Sharma for immediate intervention on 14/09/2025. Followed up via WhatsApp." },
...
export default function AdminDashboard() {
  ...
  const handleSaveNote = () => {
    ...
    // In a real app, you'd save this to a database. Here we update the mock data.
