...
const supportGroups: SupportGroup[] = [
  ...
  },
  {
    ...
    description: "Support for students dealing with academic pressure and exam stress",
    memberCount: 189,
    isPrivate: false,
    category: "Academic",
  ...
  },
  {
    ...
    description: "For students looking to build friendships and overcome social anxiety",
    memberCount: 298,
    isPrivate: false,
    category: "Social",
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-6 max-w-7xl">
        ...
        <Alert className="mb-6 border-primary/50 bg-primary/10">
          ...
          <AlertDescription>
            <strong>Community Guidelines:</strong> This is a safe space for peer support. Be respectful, maintain
            confidentiality, and report any concerning content. All posts are moderated by trained volunteers and mental
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Connect with fellow students, share experiences, and find support in a safe, moderated environment. You're
                ...
                <Dialog open={showNewPostDialog} onOpenChange={setShowNewPostDialog}>
                  ...
                  <DialogContent className="max-w-2xl">
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Share your thoughts, ask for support, or offer encouragement to fellow students.
                      </DialogDescription>
                    </DialogHeader>
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center space-x-2">
                        <Checkbox id="anonymous" checked={isAnonymousPost} onCheckedChange={setIsAnonymousPost} />
                      ...
                      <Alert>
                        ...
                        <AlertDescription className="text-sm">
                          If you're experiencing a mental health crisis, please contact emergency services or call a
                        ...
                        <div className="space-y-3">
                          <div className="flex items-center justify-between text-sm">
                            ...
                            <div className="flex items-center gap-1 text-muted-foreground">
                              ...
                              <span>Active {formatTimeAgo(group.recentActivity)}</span>
                            </div>
                          </div>
                          ...
                          <Button className="w-full" variant={group.isPrivate ? "outline" : "default"}>
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex justify-between">
                  <span className="text-sm text-muted-foreground">Support Groups</span>
            ...
            <Card className="border-destructive/20">
              ...
              <CardContent className="text-sm space-y-2">
                <p className="font-medium">If you're in crisis, get help now:</p>
