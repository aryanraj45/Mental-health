...
import { Calendar, Clock, User, Video, Phone, MapPin, Heart, MessageCircle } from "lucide-react"
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-6 max-w-6xl">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Manage your appointments and track your mental health journey</p>
        </div>
                          ...
                          <div className="flex items-start justify-between">
                            <div className="space-y-2">
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <span className="capitalize">{appointment.type.replace("-", " ")} Session</span>
                              </div>
                              <div className="text-sm text-muted-foreground">Booking ID: {appointment.bookingId}</div>
                            </div>
